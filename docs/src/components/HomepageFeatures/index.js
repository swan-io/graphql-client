...
const FeatureList = [
  ...
  {
    title: "Built with types in mind",
    svg: (
      <svg
        className={styles.svg}
        width="24"
    ...
    description: (
      <>
        Compatible with <strong>typed documents</strong>, get your TypeScript
        compiler to understand the data that goes through your application.
      </>
    ),
  },
];
